            ...
            >
                <div class="col-lg-6 col-md-12">
                    <div class="features-content">
                        ...
                        <p>{{features.descriptionOne}}</p>
                        <p>{{features.descriptionTwo}}</p>
                        <div class="btn-box">
                            <router-link to="/pricing" class="default-btn">Start Free Trial</router-link>
...
export default {
    ...
    created: async function (){
        const response = await axios.get('https://cms.pbwebvision.in/api/includedbestfeaturehometwo?populate=*')
